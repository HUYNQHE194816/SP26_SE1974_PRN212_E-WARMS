...
namespace WarrantyRepairCenter.BusinessLogicLayer
{
    internal class EmployeeBLL
    {
        ...
        public bool AddEmployee(string fullName, string username, string password, Role role, out string message)
        {
        ...
        public bool UpdateEmployee(Guid? id, string fullName, string username, Role role, out string message)
        {
            if (id is null)
            {
